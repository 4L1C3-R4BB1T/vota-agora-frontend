   ...
   return (
    ...
    {status === "open" && (
      <div className="flex justify-between items-center">
        ...
        { voted && <span className="inline-block bg-brand-primary text-white text-xs font-bold px-3 py-1 rounded-full shadow-sm">Já votada</span>}
      </div>
    )}
    {status === "closed" && (
      <div className="flex justify-between items-center">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-600">
            <strong className="text-brand-primary">Dono:</strong> {ownerName}
          </span>
        </div>
