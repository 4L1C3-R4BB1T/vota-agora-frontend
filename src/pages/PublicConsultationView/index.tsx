      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-white bg-brand-primary p-4 rounded-md flex items-center">
            ...
            Redução da tarifa dos ônibus da Real
          </CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex justify-center mt-8">
            <Button
              onClick={openModal}
              type="button"
              className="bg-brand-primary text-white hover:opacity-80 hover:bg-brand-primary/80 px-8 py-3 rounded-md shadow-lg transition duration-200 text-lg"
            >
              Votar
            </Button>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white w-96 p-6 rounded-md shadow-lg relative">
            ...
            <p className="text-gray-600 my-6">
              Por favor, escolha uma opção de voto:
            </p>
